...
async function startdiscordbot(token, player) {
    // console.log(player)
    ...
    const attachment = new AttachmentBuilder(`./player/${player.username}_output.png`);
    ...
    try {
        ...
        fs.unlinkSync(`./player/${player.username}_output.png`);
