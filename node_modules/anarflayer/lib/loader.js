...
const plugins = {
  activatePotions: require('./plugins/ActivatePotions'),
  AutoEat: require('./plugins/AutoEat'),
  ...
  joinAnarchy: require('./plugins/joinAnarchy'),
  kick: require('./plugins/kick'),
  pluginsMoveBot: require('./plugins/Move_bot'),
  ...
  autoclicker_start: require('./plugins/Tapemouse'),
  autoclicker_stop: require('./plugins/Tapemouse'),
...
function createBot (options = {}) {
  ...
  options.Movebot = options.Movebot ?? true
